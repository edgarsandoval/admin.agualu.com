    ...
    <div class="outer">
        <div class="inner bg-container">
			...
			<div class="opps-header">
				...
				<div class="opps-info">
					<div class="opps-brand"><img src="/public/img/oxxopay_brand.png" alt="OXXOPay"></div>
					<div class="opps-ammount">
						<h3>Monto a pagar</h3>
						<h2>$ {{ number_format($order->amount, 2) }} <sup>MXN</sup></h2>
						<p>OXXO cobrará una comisión adicional al momento de realizar el pago.</p>
					</div>
				</div>
				<div class="opps-reference">
					<h3>Referencia</h3>
					<h1>{{ substr(chunk_split($order->charges[0]->payment_method->reference, 4, '-'), 0, -1) }}</h1>
				</div>
			</div>
