...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-8 col-12">
                    <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                        ...
                        <li class="active breadcrumb-item">Mostrar Rangos</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div>
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Compra mínima requerida</th>
                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Acciones</th>
                                </tr>
                                </thead>
                                <tbody>
                                    @foreach ($ranges as $range)
                                        <tr role="row" class="even" data-id={{ $range->id }}>
                                            <td class="sorting_1">{{ $range->name }}</td>
                                            <td class="center">$ {{ number_format($range->minimum_volume, 2) }}</td>
                                            <td>
                                                <a class="edit" data-toggle="tooltip" data-placement="top" title="Editar" href="{{ route('edit_range', $range->id)}}">
    ...
    {!! Form::open(['route' => ['delete_range', ':USER_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@stop
{{-- page level scripts --}}
@section('scripts')
